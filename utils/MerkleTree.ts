...
// export function mimc(mimc: any, left: string, right: string): string {
//     return Buffer.from(mimc.multiHash([Buffer.from(left, 'hex'), Buffer.from(right, 'hex')])).toString('hex');
// }
...
//     levels: number;
//     mimc7: any;
//     hashLeftRight: (mimc: any, left: string, right: string) => string;
//     storage: Map<string, string>;
//     zeros: string[];
//     totalLeaves: number;
//     barretenberg: BarretenbergWasm;
...
//         this.zeros.push(currentZero);
//         for (let i = 0; i < levels; i++) {
//             currentZero = this.hashLeftRight(this.mimc7, currentZero, currentZero);
//             this.zeros.push(currentZero);
//         }
...
//                     const node = this.hashLeftRight(this.mimc7, left, right);
//                     this.storage.set(MerkleTree.indexToKey(level, i), node);
//                 }
//                 numberOfNodesInLevel = Math.ceil(numberOfNodesInLevel / 2);
//             }
